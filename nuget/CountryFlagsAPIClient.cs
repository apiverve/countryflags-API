...
namespace APIVerve.API.CountryFlags
{
    ...
    /// <summary>
    /// Client for the CountryFlags API
    /// </summary>
...
#endif
    {
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "format", new ValidationRule { Type = "string", Required = true } },
            { "shape", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        private void ValidateParams(CountryFlagsQueryOptions options)
        {
