...
```gradle
dependencies {
    implementation 'com.github.apiverve:countryflags-api:1.1.13'
}
```
...
```java
import com.apiverve.countryflags.CountryFlagsAPIClient;
import com.apiverve.countryflags.APIResponse;
import com.apiverve.countryflags.APIException;

// Initialize the client
CountryFlagsAPIClient client = new CountryFlagsAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("country", "ZW");
    parameters.put("format", "png");
    parameters.put("shape", "circle");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/countryflags](https://docs.apiverve.com/ref/countryflags)
...
- **Documentation:** [https://docs.apiverve.com/ref/countryflags](https://docs.apiverve.com/ref/countryflags)
- **Issues:** [GitHub Issues](https://github.com/apiverve/countryflags-api/issues)
