...
namespace APIVerve\Countryflags;
...
/**
 * Client for the Country Flags API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/countryflags?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/countryflags';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CountryflagsClient] {$message}\n";
        }
    }
}
