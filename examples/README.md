# Country Flags API - Examples

This folder contains example code for using the Country Flags API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/countryflags',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/countryflags");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/countryflags](https://docs.apiverve.com/ref/countryflags)
