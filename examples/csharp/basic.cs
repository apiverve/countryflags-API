/*
 * Country Flags API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Country Flags API.
 * API Documentation: https://docs.apiverve.com/ref/countryflags
 */
...
{
    class CountryFlagsExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/countryflags";

        /// <summary>
        /// Make a GET request to the Country Flags API
        /// </summary>
        static async Task<JsonDocument> CallCountryFlagsAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;country&quot;] &#x3D; &quot;ZW&quot;, [&quot;format&quot;] &#x3D; &quot;png&quot;, [&quot;shape&quot;] &#x3D; &quot;circle&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Country Flags API...\n");

            var result = await CallCountryFlagsAPI();
